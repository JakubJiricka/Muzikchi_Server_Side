...
Route::group(['prefix' => 'secure'], function () {
    ...
    Route::any('search/lang/{lang}', 'SearchController@lang');
    Route::get('search/cache/clear', function() {
    ...
    Route::get('tracks/latest', 'TopTracksController@latest');
    ...
    Route::any('tracksScore', 'TrackController@trackscore');
...
Route::get('mobilesearch/{query}', 'SearchController@mobilesearch');
